...
int main(int argc, char *argv[])
{
	...
	// scalar nu_val = 0.01; // forced datatype to remove warning. 
	...
	(
		...
		transportProperties
		// transportProperties.lookup<scalar>("nu") // this takes the value from the dictionary and returns it, passing it to the object constructor as an argument
	);
