...
extern "C" void codeStream_81c80d61a995a79d2129987c58f3fe5aeeb08d7e(Ostream& os, const dictionary& dict)
{
//{{{ begin code
    pointField points(19);
        ...
        points[11] = point(0.525, 0.125, -0.5);
        points[12] = point(0.35, 0.4, -0.5);
