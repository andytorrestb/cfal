...
extern "C" void codeStream_2575c79f27f641e5a66f25ddcc8d47eda07169f9(Ostream& os, const dictionary& dict)
{
//{{{ begin code
    pointField points(19);
        ...
        points[17] = point(0.15, 0, -0.5);
        points[18] = point(0.175, 0, -0.5);
