...
extern "C" void codeStream_ae5e486df6603d91ad9a5206df58824b7137e7e8(Ostream& os, const dictionary& dict)
{
//{{{ begin code
    pointField points(19);
        ...
        points[11] = point(0.25, 0.125, -0.5);
        points[12] = point(0.2, 0.175, -0.5);
        points[13] = point(0.35, 1, -0.5);
        points[14] = point(0, 1, -0.5);
        points[15] = point(0, 0.4, -0.5);
        points[16] = point(0, 0, -0.5);
        points[17] = point(0.125, 0, -0.5);
        points[18] = point(0.15, 0, -0.5);
