...
extern "C" void codeStream_a33c0d8c44e4684ade031260f400d6cbb186fd19(Ostream& os, const dictionary& dict)
{
//{{{ begin code
    pointField points(19);
        ...
        points[12] = point(0.4, 0.4, -0.5);
        points[13] = point(0.4, 1, -0.5);
        points[14] = point(0, 1, -0.5);
        points[15] = point(0, 0.4, -0.5);
        points[16] = point(0, 0, -0.5);
        points[17] = point(0.2, 0, -0.5);
